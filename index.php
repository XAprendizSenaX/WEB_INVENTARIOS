...
<html lang="es">
<head>
    <link rel="icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgcW54AkpoPfFPQacImJCIwpJEctdfJh4t0g&s" type="image/png">
    <meta charset="UTF-8">
    ...
    <div class="dashborad-stats">
        <?php if (!empty($estadisticas_categorias)): ?>
            <?php foreach ($estadisticas_categorias as $categoria_nombre => $conteo): ?>
                <p>Productos de <?php echo htmlspecialchars(ucfirst($categoria_nombre)); ?>: <strong><?php echo htmlspecialchars($conteo); ?></strong></p>
            <?php endforeach; ?>
        <?php else: ?>
